...
lowerBounds = -1;   % Lower Bound of Variables #lowerBounds
upperBounds = 1;   % Upper Bound of Variables  #upperBounds

% Number of Objective Functions
nObj = numel(CostFunction(unifrnd(lowerBounds, upperBounds, VarSize)));%# number of objectives
...
sigma = 0.1*(upperBounds-lowerBounds); % Mutation Step Size
...
for i = 1:nPop
    pop(i).Position = unifrnd(lowerBounds, upperBounds, VarSize);
